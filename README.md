...
Podrás encontras el proyecto implementado en el siguiente enlance

https://food-sigma.vercel.app/

La estructura general tiene dos carpetas: `api` y `client`

Se requieren las siguientes variables de entorno para hacerlo funcionar:

```
//Dentro de la carpeta api
DB_URL=something //URL asociado a la base de datos, se usó el servicio de Railway.app
API_KEY=something //key generada por Spoonacular API
ORIGIN=something //URL del cliente para configurar `headers` de la API desarrollada, se usó Vercel

//Dentro de la carpeta client
REACT_APP_API_URL=something //URL de la API desarrollada, se usó el servicio de Railway.app


```

-Se requiere reemplazar los valores apropiados
-Es necesario instalar los paquetes del `package.json`. Primero dentro de la carpeta `api` y luego la carpeta `client` independientemente
...
<p align="left">
  <img height="200" alt="home"src="Home.PNG" />
</p>

Vista de Langind Page

<p align="left">
  <img height="200" alt="landing"src="Landing.PNG" />
</p>

Formulario de creación de receta

<p align="left">
  <img height="200" alt="form"src="Form.PNG" />
</p>
...
## Comenzando [Pasos realizados para completar el proyecto]
